...
<!-- jQuery sticky menu -->
<script src="resc/site/js/owl.carousel.min.js"></script>
<script src="resc/site/js/jquery.sticky.js"></script>

<!-- jQuery easing -->
<script src="resc/site/js/jquery.easing.1.3.min.js"></script>

<!-- Main Script -->
<script src="resc/site/js/main.js"></script>

<!-- Slider -->
<script type="text/javascript" src="resc/site/js/bxslider.min.js"></script>
<script type="text/javascript" src="resc/site/js/script.slider.js"></script>
</body>
</html>