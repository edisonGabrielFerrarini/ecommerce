...
<html lang="pt-br">
  <head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="resc/site/css/bootstrap.min.css">
    
    <!-- Font Awesome -->
    <link rel="stylesheet" href="resc/site/css/font-awesome.min.css">
    
    <!-- Custom CSS -->
    <link rel="stylesheet" href="resc/site/css/owl.carousel.css">
    <link rel="stylesheet" href="resc/site/css/style.css">
    <link rel="stylesheet" href="resc/site/css/responsive.css">
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="#"><img src="resc/site/img/logo.png"></a></h1>
                    </div>
                </div>
